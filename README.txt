This is the file repository of Bugale N-Body Simulator.
...
This project is using either a modified Forward-Euler, a second order numerical differential
equations integration, or Gauss-Hermite, a fourth order one.

The project can visualize the simulation, and create a graphic real-time output using GLUT,
