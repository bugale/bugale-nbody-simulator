...
public class MainSettings
{
    ...
    [DescriptionAttribute("Determines whether the bodies and trails in 3D graphical output will be drawn as wireframes. Wireframs (as opposed to solid) drawing is much more faster but looks less realistic.")]
